...
<img src="http://test.daily-catering.de/media/image/85/a6/8f/footer-zitat.png">
        ...
        <img src="/media/image/a6/35/2c/dge-zertifikat.png" style="float:left;" width="50px">
<img src="/media/image/c1/47/c0/deutsche-see.png" style="float:left;" width="50px">
<img src="/media/image/76/a3/96/klimaneutrale-produktion.png" style="float:left;" width="50px">
<img src="/media/image/fd/07/59/klimaneutrale-lieferung.png" style="float:left;" width="50px">
        </p>
...
{block name="frontend_index_footer_column_zusatz_menu"}
   ...
   <!-- {block name="frontend_index_footer_column_service_menu_headline"}
        ...
        {block name="frontend_index_footer_column_zusatz_menu_content"}
           ...
           <li style="margin-left:20px;"><a href="../standorte/">Kontakt</a></li>
           <li style="margin-left:20px;"><a href="../standorte/">AGB</a></li>
            <li style="margin-bottom:0px;margin-left:20px;"><a href="../standorte/">Impressum</a></li>
              <li style="margin-bottom:20px;margin-left:20px;"><a href="../standorte/">Datenschutz</a></li>
        </ul>
            </nav>
        {/block}
         <!-- ... -->
